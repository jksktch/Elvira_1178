...
map.getView().fit([13169717.027393, -1023544.999834, 13639961.066140, -827378.242022], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA PERSEBARAN PARIWISATA KABUPATEN MANGGARAI BARAT FLORES NTT</h2>';
        return titleElement;
    })(),
